...
class YouTubeBmwScraper(BaseSocialMediaScraper):
    ...
    def search_influencer_in_channel(self, channel_name: str, influencer_name: str, 
                                   client_info: dict):
    ...
    def process_single_keyword(self, keyword_data: Dict[str, str]) -> bool:
        ...
        try:
            ...
            if not channel_name or not influencer_name:
                self.logger.warning("Missing channel_name or influencer_name in keyword data")
                return False
