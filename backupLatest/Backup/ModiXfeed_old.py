...
MONGO_CONNECTION_STRING = 'mongodb://admin:Cir%5EPnq%406A@51.195.235.59:27017/smFeeds?authSource=admin'
...
def get_latest_tweets(user_id, tweet_count=10):
...
def save_tweet_to_mongo(tweet, username, user_id, user_info):
    # Define client-related tags for each user
    tags = []
    ...
    tweet_data = {
        ...
        "profile_image": user_info.get('profile_image_url', 'https://abs.twimg.com/sticky/default_profile_images/default_profile_normal.png'),
        "location": user_info.get('location', ''),
        "createdAt": datetime.utcnow(),
        "tags": tags  # Add the client-related information as tags
    }
