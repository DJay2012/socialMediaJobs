...
Examples:
  ...
  python run_jobs.py --interactive                # Interactive mode
    ...
    parser.add_argument('job', nargs='?', help='Job name to run (youtubeSearch, youtubeChannel, youtubeBmw, twitter, facebook, modiTwitter)')
    parser.add_argument('--client', '-c', help='Client ID filter')
    parser.add_argument('--all', '-a', action='store_true', help='Run all available jobs')
    parser.add_argument('--list', '-l', action='store_true', help='List all available jobs')
